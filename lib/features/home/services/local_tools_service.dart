      ...
      tools.add(const {
        ...
        'function': {
          ...
          'description':
              ...
              'All returned JSON payloads contain a user-friendly "display_path" and "preview_link". When presenting files to the user, use the provided "preview_link" directly. '
