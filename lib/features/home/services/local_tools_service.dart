      ...
      tools.add(const {
        ...
        'function': {
          ...
          'description':
              ...
              'All returned JSON payloads contain a user-friendly "display_path" and "preview_link" (e.g. "[hello.html](kelivo://hello.html)"). When replying to the user, ALWAYS provide clickable markdown links so the user can tap to preview the file directly in-app. '
